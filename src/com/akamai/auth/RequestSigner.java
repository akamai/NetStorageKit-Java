...
public interface RequestSigner {
    ...
    InputStream execute(HttpURLConnection request, ClientCredential credential) throws RequestSigningException;

    InputStream execute(ClientCredential credential) throws RequestSigningException;
}
